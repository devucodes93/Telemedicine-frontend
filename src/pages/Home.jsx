  ...
  return (
    <div className="bg-white text-gray-700">
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-transform duration-500">
              <div className="text-blue-600 mb-6 flex justify-center">
                <svg
                  className="h-14 w-15"
                  viewBox="0 0 24 24"
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl duration-500 hover:scale-105 transition-transform">
              <div className="text-blue-600 mb-6 flex justify-center">
                <svg
                  ...
                  version="1.1"
                  xmlns="http://www.w3.org/2000/svg"
                  // The style properties are now individual camelCase props
                  style={{
                    fillRule: "evenodd",
                    clipRule: "evenodd",
                    strokeLinejoin: "round",
      ...
      <div className="flex flex-col items-center justify-center mb-20 bg-blue-200 pt-30 rounded-b-2xl shadow-md">
        ...
        {/* End: 3-Step Process Summary */}
        <video
          src="/assets/howitworks.mp4"
          controls
          className="h-96 w-2xl rounded-lg shadow-md mt-10 mb-20"
        />
      </div>
